...
//         <button className="bg-teal-500 text-white py-2 px-4 rounded w-full" onClick={handleImageUpload}>Upload</button>
//       </div>
//       <div className="w-1/3 bg-white p-8 rounded-lg shadow-lg ml-8">
//         <h1 className="text-2xl font-bold mb-4">Prediction</h1>
//         <p className="text-gray-900 mb-4">{prediction || "Your prediction will be generated here"}</p>
//         <p className="text-gray-500">{desc || "Description will be shown here"}</p>
//       </div>
//     </div>
//   );
// }
