...
export default function BottomNav() {
  ...
  return (
    ...
    {isHovering &&(<div className="fixed z-50 w-full h-16 max-w-lg -translate-x-1/2 bg-white border border-teal-700 rounded-full bottom-4 left-1/2 dark:bg-teal-700 dark:border-teal-600 duration-1000 ease-in ease-out">
